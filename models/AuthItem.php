...
class AuthItem extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(AuthItem::class, ['name' => 'child'])->viaTable('tbl_auth_item_child', ['parent' => 'name']);
    }
    ...
    {
        return $this->hasMany(AuthItem::class, ['name' => 'parent'])->viaTable('tbl_auth_item_child', ['child' => 'name']);
    }
